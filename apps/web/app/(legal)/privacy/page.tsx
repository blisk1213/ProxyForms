  ...
  return (
    <div className="prose mx-auto mt-8 max-w-xl px-4 pb-24">
      ...
      <p>
        ...
        application and services (collectively, the "Services"). By using our
      ...
      <ol>
        <li>
          ...
          <br />
          a. Personal Information: When you create an account, we collect your
          name, email address, and any other information you voluntarily provide
          to us.
          <br />
          b. Usage Data: We collect information about how you use our Services,
          such as the videos you create, the duration of your recordings, and
          the features you utilize.
          <br />
          c. Device Information: We may collect information about the devices
          you use to access our Services, including the hardware model,
          operating system and version, and unique device identifiers.
          <br />
        ...
        <li>
          ...
          <br />
          b. To communicate with you, provide customer support, and respond to
          your inquiries.
          <br />
        ...
        <li>
          ...
          <br />
          a. We may share your information with third-party service providers
          who assist us in operating our Services and conducting our business.
          <br />
          b. We may disclose your information if required to do so by law or in
          the good faith belief that such action is necessary to comply with
          legal obligations or to protect our rights, property, or safety, or
          that of our users or the public.
          <br />
          c. In the event of a merger, acquisition, or sale of all or a portion
        ...
        <li>
          <h3>Your Choices</h3>
          <br />
          a. You can update, correct, or delete your account information at any
          ...
          <br />
          c. You can control the use of cookies through your browser settings,
          but note that disabling cookies may limit your ability to use certain
