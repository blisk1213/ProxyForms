...
export function createProxyFormsClient({
  blogId,
  _url,
  _debug,
}: CreateClientOpts) {
  if (typeof window !== "undefined") {
    console.warn(
      "Looks like you're trying to use ProxyForms in the browser. This is not advised. We recommend using server-side rendering frameworks to fetch data."
    );
  }
